...
const (
	...
	CourseService_GetCourse_FullMethodName  = "/CourseService/GetCourse"
)
...
type CourseServiceClient interface {
	GetCourses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetCoursesResponse, error)
...
func (c *courseServiceClient) GetCourses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetCoursesResponse, error) {
...
type CourseServiceServer interface {
	GetCourses(context.Context, *emptypb.Empty) (*GetCoursesResponse, error)
...
func (UnimplementedCourseServiceServer) GetCourses(context.Context, *emptypb.Empty) (*GetCoursesResponse, error) {
